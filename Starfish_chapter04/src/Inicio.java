...
public class Inicio extends JFrame {
    ...
    public Inicio() {
        ...
        P1.setBounds(0, 0, this.getWidth(), 150);
        P1.setLayout(null);
        P1.setBackground(p3);
        ...
        Image icon = new ImageIcon("img/Title.png").getImage();
        ImageIcon cara = new ImageIcon(icon.getScaledInstance(700, 180, Image.SCALE_SMOOTH));
        Title = new JLabel(cara);
        Title.setBounds(50,0,700,180);
        ...
        Btn_last_Checkpoint.setFocusPainted(false);
